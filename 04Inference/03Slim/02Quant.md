...
<img src="./images/02Quant01.png" alt="不同精度表示" style="zoom:70%;">
...
<img src="./images/02Quant02.png" alt="神经网络的发展" style="zoom:60%;">
...
<img src="./images/02Quant04.png" alt="性能对比" style="zoom:70%;">
...
<img src="./images/02Quant05.png" alt="三种量化方法" style="zoom:70%;">
...
<img src="./images/02Quant06.png" alt="非饱和量化" style="zoom:60%;">

2. 饱和量化

饱和量化方法使用 KL 散度计算一个合适的阈值 T ($0<T<abs\_max$)，将 $±|T|$ 映射为 ±127，超出阈值  $±|T|$ 外的直接映射为阈值 ±127，则量化比例因子（scale）等于 $T/127$。

<img src="./images/02Quant07.png" alt="饱和量化" style="zoom:60%;">
...
<img src="./images/02Quant08.png" alt="对称量化" style="zoom:60%;">
...
<img src="./images/02Quant09.png" alt="非对称量化" style="zoom:60%;">

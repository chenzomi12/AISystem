...
![模型基本信息](image/04Detail03.png)

点击某一个算子节点，可以看到算子的具体信息。比如点击第一个 Gemm 可以看到：

![算子信息](image/04Detail04.png)

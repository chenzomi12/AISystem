...
![NVIDIA Feimi 架构](images/04GPU_architecture01.png)
...
![Fermi 架构线程分级](images/04GPU_architecture02.png)
...
![Kepler 架构](images/04GPU_architecture03.png)
...
![Kepler 架构改进](images/04GPU_architecture04.png)
...
![Maxwell 麦克斯韦架构](images/04GPU_architecture05.png)
...
![Maxwell 麦克斯韦 SM 架构](images/04GPU_architecture06.png)
...
![Pascal 帕斯卡架构主要创新](images/04GPU_architecture07.png)
...
![Pascal 帕斯卡架构](images/04GPU_architecture08.png)
...
![Pascal 帕斯卡架构 SM](images/04GPU_architecture09.png)
...
![Pascal 帕斯卡架构 NVLink](images/04GPU_architecture10.png)
...
![Volta 伏特架构主要改进](images/04GPU_architecture11.png)
...
![volta 伏特架构](images/04GPU_architecture12.png)
...
![Volta 伏特架构 SM 结构](images/04GPU_architecture13.png)
...
![Volta 伏特架构 Tensor Core 计算](images/04GPU_architecture14.png)
...
![Volta 伏特架构 V100](images/04GPU_architecture15.png)
...
![12 个 NVSwitch 1.0 连接 16 个 V100](images/04GPU_architecture16.png)
...
![Turing 图灵架构](images/04GPU_architecture18.png)
...
![RT Core 效果对比](images/04GPU_architecture20.png)
...
![Ampere 安培架构主要特性](images/04GPU_architecture21.png)
...
![Ampere 安培架构](images/04GPU_architecture22.png)
...
![Ampere 架构 TF32、BF16 和 FP64](images/04GPU_architecture23.png)
...
![Ampere 架构 A100 支持精度](images/04GPU_architecture24.png)
...
![Ampere 架构稀疏化流程](images/04GPU_architecture25.png)
...
![Ampere 架构多实例分割虚拟 GPU](images/04GPU_architecture26.png)
...
![A100 硬件规格](images/04GPU_architecture27.png)
...
![Hopper 赫柏架构](images/04GPU_architecture29.png)
...
![Hopper 赫柏架构 SM](images/04GPU_architecture30.png)
...
![H100 异构系统](images/04GPU_architecture31.png)
...
![8 年时间 AI 计算性能提升了 1000 倍](images/04GPU_architecture35.png)
...
![NVIDIA GB200 NVL72 集群](images/04GPU_architecture36.png)
...
![NVIDIA 为满足模型需要不断创新](images/04GPU_architecture37.jpg)

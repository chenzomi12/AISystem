...
![内存中数据示意图](images/memory01.png)
===== 图片统一命名，04LayoutPrinc.md，那么图片命名为04LayoutPrinc01.png 这种格式
...
![无内存对齐机制示意图](images/memory02.png)
...
![3 维张量行优先示意图](images/tensor01.png)

下图为列优先排布方式，按列的顺序以红橙红橙红橙的排布方式，第二个通道绿蓝绿蓝绿蓝的排布方式进行存储。

![3 维张量列优先示意图](images/tensor02.png)
...
![3 维张量数据布局方式列举图](images/tensor05.png)
...
![NCHW 计算灰度值示意图](images/nchw02.png)
